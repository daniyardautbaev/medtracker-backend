...
Проект включает **Frontend**, разработанный с использованием **Next.js**, который взаимодействует с API и предоставляет удобный интерфейс для управления данными.
GitHub репозиторий Frontend части:https://github.com/daniyardautbaev/medtracker-frontend
